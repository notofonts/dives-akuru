...
<h2>Check results</h2><details><summary><b>[15] NotoSerifDivesAkuru-Regular.ttf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Noto fonts must have an ARTICLE.en_us.html file (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/description/noto_has_article">com.google.fonts/check/description/noto_has_article</a>)</summary><div>
...
* 🔥 **FAIL** OS/2.usWinAscent value should be equal or greater than 1751, but got 1069 instead [code: ascent]
...
* 🔥 **FAIL** Current FontBakery version is 0.11.2, while a newer 0.13.1 is already available. Please upgrade it with 'pip install -U fontbakery' [code: outdated-fontbakery]
 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: math, malayalam, old-permic, syriac, tifinagh, canadian-aboriginal, tai-le, coptic
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: phags-pa, masaram-gondi, bengali, kannada, coptic, music, balinese, sharada, ahom, tifinagh, sogdian, javanese, myanmar, pahawh-hmong, bhaiksuki, saurashtra, modi, gurmukhi, tagalog, zanabazar-square, brahmi, gunjala-gondi, buginese, wancho, gujarati, kayah-li, hebrew, old-permic, tibetan, devanagari, tai-viet, meetei-mayek, newa, batak, armenian, psalter-pahlavi, khojki, syloti-nagri, telugu, thaana, soyombo, nko, new-tai-lue, sundanese, oriya, kaithi, lao, malayalam, manichaean, elbasan, mende-kikakui, duployan, khmer, warang-citi, hanifi-rohingya, buhid, canadian-aboriginal, takri, siddham, syriac, rejang, mandaic, limbu, khudawadi, kharoshthi, osage, symbols, bassa-vah, cham, sinhala, lepcha, caucasian-albanian, thai, grantha, tamil, hanunoo, mahajani, math, tagbanwa, tirhuta, chakma, yi, marchen, miao, mongolian, tai-tham, dogra, adlam, tai-le
...
Your font does *not* cover the following languages that require the soft-dotted feature: Mundani (Latn, 34,000 speakers), Belarusian (Cyrl, 10,064,517 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Ejagham (Latn, 120,000 speakers), Bete-Bendi (Latn, 100,000 speakers), Ekpeye (Latn, 226,000 speakers), Yala (Latn, 200,000 speakers), Kom (Latn, 360,685 speakers), Mango (Latn, 77,000 speakers), Ebira (Latn, 2,200,000 speakers), Sar (Latn, 500,000 speakers), Ngbaka (Latn, 1,020,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Cicipu (Latn, 44,000 speakers), Koonzime (Latn, 40,000 speakers), Makaa (Latn, 221,000 speakers), Igbo (Latn, 27,823,640 speakers), Lugbara (Latn, 2,200,000 speakers), Gulay (Latn, 250,478 speakers), South Central Banda (Latn, 244,000 speakers), Fur (Latn, 1,230,163 speakers), Zapotec (Latn, 490,000 speakers), Dan (Latn, 1,099,244 speakers), Bafut (Latn, 158,146 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Southern Kisi (Latn, 360,000 speakers), Aghem (Latn, 38,843 speakers), Mfumte (Latn, 79,000 speakers), Nateni (Latn, 100,000 speakers), Nzakara (Latn, 50,000 speakers), Basaa (Latn, 332,940 speakers), Dii (Latn, 71,000 speakers), Avokaya (Latn, 100,000 speakers), Navajo (Latn, 166,319 speakers), Ma’di (Latn, 584,000 speakers). [code: soft-dotted]
